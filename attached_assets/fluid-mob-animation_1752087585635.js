...
function fluid_init() {
	...
	// touch
	document.querySelector('.nicol').addEventListener('touchstart', e => {
            ...
            let el = document.querySelector('.nicol');
	...
	document.querySelector('.nicol').addEventListener('touchmove', e => {
		const touches = e.targetTouches;
		let el = document.querySelector('.nicol');
		let rect = el.getBoundingClientRect();
		for (let i = 0; i < touches.length; i++) {
