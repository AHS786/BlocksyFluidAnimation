...
function fluid_init() {
        ...
        let fluid_bg = canvas.getAttribute('data-fluid-bg') ? canvas.getAttribute('data-fluid-bg') : "#02030F",
                ...
                quality = canvas.getAttribute('data-quality') ? canvas.getAttribute('data-quality') : 256,
        ...
        // touch
        document.querySelector('.blocksy, body').addEventListener('touchstart', e => {
            ...
            let el = document.querySelector('.blocksy, body');
            ...
            for (let i = 0; i < touches.length; i++) {
                ...
                pointers[i].dx = (touches[i].clientX - pointers[i].x) * 8.0;
                pointers[i].dy = (touches[i].clientY - pointers[i].y) * 8.0;
                pointers[i].texcoordX = posX / parseFloat(el.offsetWidth);
                pointers[i].texcoordY = 1 - (posY / parseFloat(el.offsetHeight));
        ...
        document.querySelector('.blocksy, body').addEventListener('touchmove', e => {
                const touches = e.targetTouches;
                let el = document.querySelector('.blocksy, body');
                let rect = el.getBoundingClientRect();
                for (let i = 0; i < touches.length; i++) {
                        ...
                        pointer.texcoordX = posX / parseFloat(el.offsetWidth);
                        pointer.texcoordY = 1 - (posY / parseFloat(el.offsetHeight));
